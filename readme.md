...
``python dqn_atari.py --env=Assault-v0 --train --net_mode=duel --num_episodes_at_test=20 --task_name 'RNN_keras_a-t_bi' --num_frames 10 --recurrent --replay_memory_size=500000``
